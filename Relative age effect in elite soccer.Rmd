...
Summarise the findings of the model results. See the *Result* section at **page 4** in the article. Here, pick out some of the countries that you interested. Make comparison between the countries. Make comment on the model fit as well.
...
Summarise the findings of the overall model results. Interpret the parameters here basing on the content of the article.

# III: Commentary & Future work

**TODO:**

Make some comment on the model results. Highlight the strength and drawbacks of the model, and further interests.


**TODO:**

Typo check before submitting
